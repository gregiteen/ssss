...
```
my-app/
  package.json        @gregiteen/ssss-cli pinned to this CLI's version tag; npm test = node --test
...
| `--ref <git-ref>` | Pin `@gregiteen/ssss-cli` to a specific tag/branch/SHA (default: this CLI's version tag). |
