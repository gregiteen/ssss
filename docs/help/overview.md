...
| Core registry | `registry/core.json` | The 13 document primitives + 5 contract primitives, plus the bundle (§16) and provisioning (§17) schemas. |
...
`portability`, `bundle`, `provisioning`, `export`, `provision`, `import`, `conformance`, `autolink`.
